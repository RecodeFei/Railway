...
public class WorkloadDB {
	 ...
	 * @throws Exception
	 */
	public List<Workload> query() throws SQLException{
	...
	public void addWorkload(Workload Workload) throws Exception{
		//获取数据库连接
		Connection conn = DBUtil.getConnection();
	...
	public Workload get(Integer id) throws SQLException{
		Workload bs = null;
	...
	public List<Workload> get(List<Map<String, Object>> params) throws SQLException{
