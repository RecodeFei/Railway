...
public class FindfaultHandle {
	...
	public List<FindfaultInfo> query() throws SQLException{
		...
		sb.append("select id,time,date,car_type,fault_name,fault_type,team,name,money from railway_findfault");
	...
	public void addFindfaultInfo(FindfaultInfo FindfaultInfo) throws Exception{
		...
		String sql = "insert into railway_findfault(time,date,car_type,fault_name,fault_type,team,name,money)values(?,?,?,?,?,?,?,?)";
		...
		ptmt.setString(6, FindfaultInfo.getTeam());
		ptmt.setString(7, FindfaultInfo.getName());
		ptmt.setString(8, FindfaultInfo.getMoney());
	...
	public void updateFindfaultInfo(FindfaultInfo FindfaultInfo) throws SQLException{
		...
		String sql="" +
				...
				"set time=?,date=?,car_type=?,fault_name=?,fault_type=?,team=?,name=?,money=? "+
